#############################################################################
# Makefile for building: /usr/local/bin/jk
# Generated by qmake (3.1) (Qt 5.15.16)
# Project:  jk.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile jk.pro
#############################################################################
...
COMPRESS      = gzip -9f
DISTNAME      = jk1.0.0
DISTDIR = /home/edamame-maru/jk/.tmp/jk1.0.0
LINK          = g++
...
TARGET        = /usr/local/bin/jk


first: all
####### Build rules

/usr/local/bin/jk:  $(OBJECTS)  
	@test -d /usr/local/bin/ || mkdir -p /usr/local/bin/
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: jk.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
